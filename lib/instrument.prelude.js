(function(options) {
    ...
    defineHiddenProperty(window, "__jsnapHiddenProp__recordArguments_method", function(prop, arguments) {
        var obj = this;
        return window.__jsnapHiddenProp__recordArguments.__jsnapHiddenProp__call(obj, obj[prop], arguments)
    });

    defineHiddenProperty(window, "__jsnapHiddenProp__recordArguments", function(func, arguments) {
        ...
        var result = func.__jsnapHiddenProp__apply(this, arguments);
